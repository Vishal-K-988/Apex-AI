...
import { GetStarted_Button } from "./components/GetStarted";
...
export default function Home() {
  ...
  <div>
    <header className="flex justify-between items-center p-9 mx-auto ">
      <Image src="/logo image.png" alt="logo" width={60} height={100} />
      <GetStarted_Button/>
    </header>
    </div>
...
<div className="flex justify-between items-center p-9 mx-auto " >
